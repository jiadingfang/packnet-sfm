...
from packnet_sfm.geometry.camera_plumb import PlumbCamera
...
class PlumbMultiViewPhotometricLoss(LossBase):
    """
...
########################################################################################################################
    ...
    def warp_ref_image(self, inv_depths, ref_image, I, ref_I, pose):
        ...
        for i in range(self.n):
            ...
            cams.append(PlumbCamera(I=I).to(device))
            ref_cams.append(PlumbCamera(I=ref_I, Tcw=pose).to(device))
        # View synthesis
