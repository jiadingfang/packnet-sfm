...
from packnet_sfm.models.FOVSfmModel import FOVSfmModel
from packnet_sfm.losses.fov_multiview_photometric_loss import FOVMultiViewPhotometricLoss
from packnet_sfm.models.model_utils import merge_outputs

import numpy as np
from PIL import Image

class FOVSelfSupModel(FOVSfmModel):
    """
    ...
    def __init__(self, **kwargs):
        ...
        self._photometric_loss = FOVMultiViewPhotometricLoss(**kwargs)
    ...
    def forward(self, batch, return_logs=False, progress=0.0):
        ...
        self.I_dict = {'fx': I[0].item(), 'fy': I[1].item(), 'cx': I[2].item(), 'cy': I[3].item(), 'w': I[4].item()}
