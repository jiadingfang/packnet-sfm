...
from packnet_sfm.models.EUCMSfmModel import EUCMSfmModel
...
from packnet_sfm.losses.eucm_multiview_photometric_loss import EUCMMultiViewPhotometricLoss
from packnet_sfm.models.model_utils import merge_outputs

import numpy as np
from PIL import Image

class EUCMSelfSupModel(EUCMSfmModel):
    """
    ...
    def __init__(self, **kwargs):
        ...
        self._photometric_loss = EUCMMultiViewPhotometricLoss(**kwargs)
    ...
    def forward(self, batch, return_logs=False, progress=0.0):
        ...
        self.I_dict = {'fx': I[0].item(), 'fy': I[1].item(), 'cx': I[2].item(), 'cy': I[3].item(), 'alpha': I[4].item(), 'beta': I[5].item()}
