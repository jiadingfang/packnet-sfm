...
class PlumbDecoder(nn.Module):
    def __init__(self, num_ch_enc, scales=[0], num_output_channels=3, use_skips=True):
        ...
        # i = torch.tensor([250.2/1000, 261.3/1000, 187.2/1000, 132.8/1000, (-0.283 + 5)/10, 0.074/30])
        # # i = i * 1.10
        ...
        self.intrinsic_vector = nn.Parameter(-2*torch.ones(6))
    ...
    def forward(self, input_features):
        ...
        k1 = self.sigmoid(self.intrinsic_vector[4]) * 10 - 5
        k2 = self.sigmoid(self.intrinsic_vector[5]) * 30
