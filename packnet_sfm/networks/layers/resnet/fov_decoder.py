...
class FOVDecoder(nn.Module):
    def __init__(self, num_ch_enc, scales=[0], num_output_channels=3, use_skips=True):
        ...
        i = torch.tensor([234.45/1000, 243.19/1000, 186.24/1000, 132.64/1000, 0.921])
        # i = i * 1.10
    ...
    def forward(self, input_features):
        ...
        w = self.sigmoid(self.intrinsic_vector[4]) * math.pi
