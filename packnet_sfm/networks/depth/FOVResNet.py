...
from packnet_sfm.networks.layers.resnet.fov_decoder import FOVDecoder
from packnet_sfm.networks.layers.resnet.layers import disp_to_depth

########################################################################################################################

class FOVResNet(nn.Module):
    """
    ...
    def __init__(self, version=None, **kwargs):
        ...
        self.intrinsic_decoder = FOVDecoder(num_ch_enc=self.encoder.num_ch_enc)
