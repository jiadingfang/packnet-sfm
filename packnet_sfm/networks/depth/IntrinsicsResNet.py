...
from packnet_sfm.networks.layers.resnet.intrinsics_decoder import IntrinsicsDecoder
from packnet_sfm.networks.layers.resnet.layers import disp_to_depth

########################################################################################################################

class IntrinsicsResNet(nn.Module):
    """
    ...
    def __init__(self, version=None, **kwargs):
        ...
        self.intrinsic_decoder = IntrinsicsDecoder(num_ch_enc=self.encoder.num_ch_enc)
