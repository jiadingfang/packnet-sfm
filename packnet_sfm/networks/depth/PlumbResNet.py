...
from packnet_sfm.networks.layers.resnet.plumb_decoder import PlumbDecoder
from packnet_sfm.networks.layers.resnet.layers import disp_to_depth

########################################################################################################################

class PlumbResNet(nn.Module):
    """
    ...
    def __init__(self, version=None, **kwargs):
        ...
        self.intrinsic_decoder = PlumbDecoder(num_ch_enc=self.encoder.num_ch_enc)
